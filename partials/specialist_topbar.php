    ...
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
        <div class="navbar-vertical-content perfect-scrollbar scrollbar">
            <ul class="navbar-nav flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="specialist_dashboard">
                        <div class="d-flex align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="specialist_customers">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="specialist_pets_categories">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="specialist_pets">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse" id="pages" data-parent="#navbarVerticalCollapse">
                        <li class="nav-item"><a class="nav-link" href="specialist_ailment">Ailment </a></li>
                        <li class="nav-item"><a class="nav-link" href="specialist_category_ailments">Category Ailments</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="specialist_clinic_vists">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse" id="page" data-parent="#navbarVerticalCollapse">
                        <li class="nav-item"><a class="nav-link" href="specialist_reports_customer_pets">Customer Pets </a></li>
                        <li class="nav-item"><a class="nav-link" href="specialist_reports_clinic_vists">Clinic Visits</a></li>
                        <li class="nav-item"><a class="nav-link" href="specialist_reports_customers">Customers</a></li>
                    </ul>
                </li>
                <li class="nav-item">
